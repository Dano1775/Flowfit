...
<div class="container main-content">
  <div class="glass-card px-4 py-5 shadow-lg">
    <h2 class="text-center mb-4 text-success hero-title">Historial de Rutinas Asignadas</h2>
    ...
    <?php if (count($asignaciones) > 0): ?>
      ...
      <div class="text-center mt-4">
        <a href="historial_asignaciones.php?exportar=1" class="btn btn-success px-4">
          Exportar a Excel
        </a>
      </div>
    <?php else: ?>
