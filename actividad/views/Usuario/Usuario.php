...
<section class="hero-section d-flex align-items-center justify-content-center text-center">
  <div class="container py-5 mt-4">
    ...
    <p class="lead mt-2">Consulta tus rutinas, visualiza tu progreso y mantén tu perfil actualizado.</p>
    <div class="d-flex justify-content-center gap-3 flex-wrap mt-3">
      <a href="#panel" class="btn btn-success px-4">Ir al Panel</a>
      <a href="https://flowfit.com/manual-usuario" class="btn btn-outline-light px-4">Guía de Uso</a>
    </div>
  </div>
</section>
  ...
  <div class="row g-4 justify-content-center">
    ...
    <div class="col-md-4 col-sm-6">
      <div class="card text-center p-4">
        ...
        <h5>Progreso</h5>
        <p>Visualiza tus avances y logros personales.</p>
        <a href="progreso.php" class="btn btn-success mt-2">Ver progreso</a>
      </div>
    </div>
