...
<!-- FOOTER: Mantener -->
<footer class="footer mt-auto text-center text-white pt-3 pb-2">
  <p>© <?= date("Y") ?> FlowFit. Todos los derechos reservados.</p>
  <p>
    Síguenos en 
    <a href="#" class="text-accent">Instagram</a> · 
    <a href="#" class="text-accent">Facebook</a> · 
    <a href="#" class="text-accent">X</a>
  </p>
</footer>
